...
public class UberRidesDemo {
    public static void main(String[] args) {
        ...
        Command request1 = new RideRequestCommand(rideService, "Sumit", "Mahadevpura", "Bellandur");
        Command request2 = new RideRequestCommand(rideService, "Surbhi", "Sarjapur", "Indiranagar");
        Command cancel1 = new CancelRideCommand(rideService, "Sumit");
